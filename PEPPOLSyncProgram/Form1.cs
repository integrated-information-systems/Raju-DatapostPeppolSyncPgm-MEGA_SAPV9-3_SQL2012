        ...
        private void ReceiveInvoice_Service()
        {
            try
            {
                ...
                do
                {
                    ...
                    if (pEPPOLInvoiceReceipt == null)
                        return;
                    if (pEPPOLInvoiceReceipt.info == null)
                        return;
            ...
            try
            {
                ...
                using (var dbcontext = new EFSapDbContext())
                {
                    ...
                    if (invoiceHeaderObject != null)
                        ...
                        //contactPersonObj = dbcontext.ContactPerson.Where(x => x.CntctCode.Equals(invoiceHeaderObject.cntctcode)).
                }
                       ...
                       // Note = (invoiceHeaderObject.Comments != null) ? invoiceHeaderObject.Comments : "-",
                        ...
                        AccountingCustomerParty = new AccountingCustomerParty
                        {
                            Party = new Party
                            {
                                ...
                                Contact = new Contact
                                {
                                    Name = contactPersonObj!= null ? ((contactPersonObj.Name != null) ? contactPersonObj.Name : "-") : "-" //Need confirmation
                                    //Name = invoiceHeaderObject.cntctcode.ToString(),
                                    //ElectronicMail = "-"
